            ...
            <div class="text">
                ...
                if ($DH <= 8 && $C1) {
                    ...
                    if (isset($playerChoice)) {
                        if ($playerChoice == $FáfnirChoice) {
                            echo "Your choice: $playerChoice <br>  Fáfnir's choice: $FáfnirChoice<br>";
                            echo "No one is harmed";
                        } elseif (($playerChoice == 'rock' && $FáfnirChoice == 'scissors') ||
                            ($playerChoice == 'paper' && $FáfnirChoice == 'rock') ||
                            ($playerChoice == 'scissors' && $FáfnirChoice == 'paper')) {
                            echo "Your choice: $playerChoice <br> Fáfnir's choice: $FáfnirChoice <br>";
                            echo "You damaged the dragon";
                        } else {
                            echo "Your choice: $playerChoice <br>  Fáfnir's choice: $FáfnirChoice<br>";
                            echo "You were damaged by the dragon";
                        }
                    } else {
                        echo "You encountered the battle with the mighty dragon. You have to win the rock, paper, and scissors game to deal damage.";
                    }
                }
                ?>
            </div>
