...
<body>
    ...
    function playGame($background, $enemy, $next, $intro, $outro, $begin, $ends) {
        ...
        if (isset($_POST['action']) && ($_SESSION["playerHP"] > 0) && ($_SESSION["monsterHP"] > 0)) {
            ...
            setMoves();
        } else if ($_SESSION["playerHP"] == 0 || $_SESSION["monsterHP"] == 0) {
    ...
    function setConclusionPage($path) {
        setBackground($path);
        print "<div class = \"conclusion\"><h1>Congradulations!!" . $_SESSION["UserName"] . "</h1><img src = \"./Images/Common/favicon.png\"><div class = \"msg\">Congradulation, you have over came the odds and defeat Fáfnir through rock, paper, scissors. Through these trials, you have overcame each obstacle either through luck, skill, or just pure determination. if you have logged in, the leader board may have update. And thank you for playing another of our game by the Web Enchantment Devs.</p><button class = \"return\"><a href = \"https://codd.cs.gsu.edu/~yliu117/Project/P2/index.php\">Return to Menu</a></button></div></div>";
    }
